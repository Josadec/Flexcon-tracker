<div class="space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Editar Semi-automático</h1>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Modifica la información del semi-automático {{ $semiAutomatic->number }}</p>
        </div>
    </div>
        ...
        <form wire:submit="update" class="divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <div class="p-6 bg-gray-50 dark:bg-gray-900/50">
                <div class="flex justify-end gap-3">
                    <a 
                        href="{{ route('admin.semi-automatics.index') }}" 
