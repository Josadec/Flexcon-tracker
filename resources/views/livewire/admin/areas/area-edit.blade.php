<div class="space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Editar Área</h1>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Modifica la información del área</p>
        </div>
    </div>

    <!-- Form -->
    <div class="bg-white dark:bg-gray-800 rounded-lg">
        <form wire:submit="updateArea" class="divide-y divide-gray-200 dark:divide-gray-700">
            <div class="p-6">
                <h3 class="text-base font-semibold text-gray-900 dark:text-white mb-4">Información del Área</h3>
                <div class="space-y-4">
                    <div>
