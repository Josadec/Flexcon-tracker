<x-ui.page eyebrow="Administración" :title="$department->name" :subtitle="$department->description ?: 'Detalle del departamento y de las áreas que agrupa.'" back="{{ route('admin.departments.index') }}"
    ...
    <x-ui.stats cols="4">
        ...
        <x-ui.stat label="Máquinas" :value="$stats['total_machines']" tone="info" :help="$stats['active_machines'] . ' activas de ' . $stats['total_machines'] . '.'" />
        <x-ui.stat label="Mesas" :value="$stats['total_tables']" tone="info" :help="$stats['active_tables'] . ' activas de ' . $stats['total_tables'] . '.'" />
        <x-ui.stat label="Semi-automáticos" :value="$stats['total_semi_automatic']" tone="info" :help="$stats['active_semi_automatic'] . ' activos de ' . $stats['total_semi_automatic'] . '.'" />
    </x-ui.stats>
