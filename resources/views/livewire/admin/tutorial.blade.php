...
>
    {{-- HEADER --}}
    <div class="bg-white dark:bg-zinc-800 border-b border-zinc-200 dark:border-zinc-700 px-6 py-6 shadow-sm">
        <div class="max-w-6xl mx-auto flex items-center gap-4">
            <div class="flex-shrink-0 w-14 h-14 bg-blue-600 rounded-2xl flex items-center justify-center shadow-lg">
            ...
            <div>
                <h1 class="text-2xl font-bold text-zinc-900 dark:text-white">Tutorial y Guía del Sistema</h1>
                <p class="text-sm text-zinc-500 dark:text-zinc-400 mt-0.5">Flexcon Tracker — Aprende a usar cada módulo paso a paso</p>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-6xl mx-auto px-6 py-8">
        ...
        <div class="mb-8 flex flex-wrap gap-2">
            ...
            <button
                ...
                :class="section === '{{ $tab['key'] }}'
                    ? 'bg-{{ $tab['color'] }}-600 text-white shadow-md ring-2 ring-{{ $tab['color'] }}-400'
                    : 'bg-white dark:bg-zinc-800 text-zinc-600 dark:text-zinc-300 border border-zinc-200 dark:border-zinc-700 hover:border-{{ $tab['color'] }}-400 hover:text-{{ $tab['color'] }}-600'"
        ...
        @endif
            ...
            {{-- Bienvenida General --}}
            <div class="bg-gradient-to-r from-zinc-700 to-zinc-900 rounded-2xl p-7 text-white shadow-lg">
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        <h2 class="text-xl font-bold mb-2">Bienvenido a Flexcon Tracker</h2>
                        <p class="text-zinc-300 text-sm leading-relaxed">Flexcon Tracker es el sistema ERP de seguimiento de producción de Flexcon. Centraliza el control de órdenes de compra, órdenes de trabajo, producción, calidad, materiales y empaques en una sola plataforma. Este tutorial te guiará por cada módulo según tu rol.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-zinc-800 rounded-2xl border border-zinc-200 dark:border-zinc-700 overflow-hidden shadow-sm">
                ...
                <div class="p-6">
                    ...
                    <div class="flex flex-wrap items-center justify-center gap-2">
                        ...
                        <div class="flex items-center gap-2">
                            <div class="flex flex-col items-center">
                                <div class="w-16 h-16 bg-{{ $step['color'] }}-100 dark:bg-{{ $step['color'] }}-900/30 border-2 border-{{ $step['color'] }}-400 rounded-xl flex items-center justify-center">
                    ...
                    <div class="mt-4 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700 rounded-xl p-4">
            ...
            <div class="bg-white dark:bg-zinc-800 rounded-2xl border border-zinc-200 dark:border-zinc-700 overflow-hidden shadow-sm">
                ...
                <div class="p-6 space-y-5">
                    ...
                    <div class="bg-zinc-50 dark:bg-zinc-700/50 rounded-xl p-5">
        ...
        <div x-show="section === 'admin'" x-transition.opacity.duration.300ms class="space-y-8">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-blue-800 rounded-2xl p-7 text-white shadow-lg">
                <div class="flex items-start gap-4">
                    <div class="w-12 h-12 bg-white/10 rounded-xl flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                        ...
                        <p class="text-blue-100 text-sm leading-relaxed">Como administrador tienes acceso completo al sistema. Esta guía cubre todos los módulos: Purchase Orders, Work Orders, Catálogos (partes, precios, estándares), Capacity Wizard y la administración del sistema (usuarios, empleados, turnos, mesas, roles y más).</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-zinc-800 rounded-2xl border border-zinc-200 dark:border-zinc-700 overflow-hidden shadow-sm">
                ...
                <div class="p-6 space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="flex gap-4 bg-zinc-50 dark:bg-zinc-700/50 rounded-xl p-4">
                    ...
                    <div class="bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-200 dark:border-indigo-700 rounded-xl p-4">
            ...
            <div class="bg-white dark:bg-zinc-800 rounded-2xl border border-zinc-200 dark:border-zinc-700 overflow-hidden shadow-sm">
                ...
                <div class="p-6 space-y-5">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="bg-zinc-50 dark:bg-zinc-700/50 rounded-xl p-4 space-y-2">
        ...
        <div
            ...
            class="space-y-8"
        >
            <div class="bg-gradient-to-r from-orange-500 to-orange-700 rounded-2xl p-7 text-white shadow-lg">
                <div class="flex items-start gap-4">
                    <div class="w-12 h-12 bg-white/10 rounded-xl flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                        ...
                        <p class="text-orange-100 text-sm leading-relaxed">El rol Producción registra el trabajo realizado en planta: pesadas, kits, lotes y listas de envío. Todo lo fabricado pasa por este módulo antes de ir a Calidad.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-zinc-800 rounded-2xl border border-zinc-200 dark:border-zinc-700 overflow-hidden shadow-sm">
                ...
                <div class="p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                            <div class="flex gap-3 bg-zinc-50 dark:bg-zinc-700/50 rounded-xl p-3">
                ...
                <div class="p-6 space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-700 rounded-xl p-3">
        ...
        <div
            ...
            class="space-y-8"
        >
            <div class="bg-gradient-to-r from-green-600 to-green-800 rounded-2xl p-7 text-white shadow-lg">
                <div class="flex items-start gap-4">
                    <div class="w-12 h-12 bg-white/10 rounded-xl flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                        ...
                        <p class="text-green-100 text-sm leading-relaxed">El rol Calidad inspecciona los lotes provenientes de Producción, registra resultados, aprueba o rechaza, y mantiene los registros de calidad necesarios para la trazabilidad del cliente.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-zinc-800 rounded-2xl border border-zinc-200 dark:border-zinc-700 overflow-hidden shadow-sm">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div class="bg-red-50 dark:bg-red-900/20 rounded-xl p-4 border border-red-100 dark:border-red-800">
        ...
        <div
            ...
            class="space-y-8"
        >
            <div class="bg-gradient-to-r from-purple-600 to-purple-800 rounded-2xl p-7 text-white shadow-lg">
                <div class="flex items-start gap-4">
                    <div class="w-12 h-12 bg-white/10 rounded-xl flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                        ...
                        <p class="text-purple-100 text-sm leading-relaxed">El rol Materiales es responsable de surtir los materiales e insumos necesarios para que Producción pueda iniciar el trabajo en cada Work Order. Sin el surtimiento registrado, Producción no puede comenzar.</p>
                    </div>
                </div>
            </div>
        ...
        <div
            ...
            class="space-y-8"
        >
            <div class="bg-gradient-to-r from-pink-600 to-pink-800 rounded-2xl p-7 text-white shadow-lg">
                <div class="flex items-start gap-4">
                    <div class="w-12 h-12 bg-white/10 rounded-xl flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                        ...
                        <p class="text-pink-100 text-sm leading-relaxed">El rol Empaques recibe los lotes aprobados por Calidad, realiza el proceso de empaque según las especificaciones del cliente, genera los Packing Slips (FPL-10) y coordina el despacho final al cliente.</p>
                    </div>
                </div>
            </div>
            <div class="bg-pink-50 dark:bg-pink-900/20 border border-pink-200 dark:border-pink-800 rounded-xl p-4">
            ...
            <div class="bg-white dark:bg-zinc-800 rounded-2xl border border-zinc-200 dark:border-zinc-700 overflow-hidden shadow-sm">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="bg-pink-50 dark:bg-pink-900/20 rounded-xl p-4 border border-pink-100 dark:border-pink-800">
        ...
        {{--                   PIE DE PÁGINA COMÚN                   --}}
        {{-- ═══════════════════════════════════════════════════════ --}}
        <div class="mt-12 bg-white dark:bg-zinc-800 rounded-2xl border border-zinc-200 dark:border-zinc-700 overflow-hidden shadow-sm">
            <div class="flex items-center gap-3 px-6 py-4 bg-zinc-50 dark:bg-zinc-700/50 border-b border-zinc-200 dark:border-zinc-700">
                <div class="w-8 h-8 bg-zinc-600 rounded-lg flex items-center justify-center flex-shrink-0">
                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                </div>
            ...
            <div class="p-6">
                ...
                <div class="mt-4 bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-200 dark:border-indigo-700 rounded-xl p-4">
