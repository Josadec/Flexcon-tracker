...
{
    /**
     * Pesadas de PIEZAS ("manguitas") en Empaque para partes con CRIMP.
     * Se registran a nivel viajero (lots). Cantidad capturada manualmente;
     * el peso es opcional. Separadas de las pesadas de CRIMP.
     * Ref: 01_modulos_afectados.md → M6 · Empaque (Paso 4-5).
     */
    public function up(): void
    {
        Schema::create('packaging_piece_weighings', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('packaging_piece_weighings');
    }
};
