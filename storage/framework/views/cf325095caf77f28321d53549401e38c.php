    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center space-x-4">
                <a href="<?php echo e(route('admin.semi-automatics.index')); ?>" class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path>
                    </svg>
                </a>
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Nuevo Semi-automático</h1>
                    <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                        Registra un nuevo equipo semi-automático en el sistema
                    </p>
                </div>
            </div>
        </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                    <div class="flex items-center justify-end space-x-4">
                        <a href="<?php echo e(route('admin.semi-automatics.index')); ?>" 
...
</div><?php /**PATH C:\xampp\htdocs\Flexcon-tracker\resources\views/livewire/admin/semi-automatics/semi-automatic-create.blade.php ENDPATH**/ ?>