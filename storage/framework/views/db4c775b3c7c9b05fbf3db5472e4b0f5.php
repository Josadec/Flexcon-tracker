    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Crear Empleado</h1>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div>
                            <label for="employee_number" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                                Número de Empleado
                            </label>
                            <input wire:model="employee_number" type="text" id="employee_number"
                                class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div>
                            <label for="entry_date" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                                Fecha de Ingreso
                            </label>
                            <input wire:model="entry_date" type="date" id="entry_date"
                                class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 dark:bg-gray-700 dark:text-white">
                ...
                <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                    ...
                    <div class="mb-4">
                        <label class="flex items-center">
                            ...
                            <span class="ml-2 text-sm font-medium text-gray-700 dark:text-gray-300">Empleado Activo</span>
                        </label>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea wire:model="comments" id="comments" rows="3"
                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 dark:bg-gray-700 dark:text-white resize-none"
...
<?php /**PATH C:\xampp\htdocs\Flexcon-tracker\resources\views/livewire/admin/employees/employee-create.blade.php ENDPATH**/ ?>