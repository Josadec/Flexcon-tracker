    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Work Order: <?php echo e($workOrder->wo_number); ?></h1>
                ...
                <div class="p-6">
                    ...
                    <dl class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <dd class="mt-1 text-sm text-gray-900 dark:text-white font-semibold"><?php echo e($workOrder->purchaseOrder->wo); ?></dd>
                        </div>
                        ...
                        <div>
                            ...
                            <dd class="mt-1 text-sm text-gray-900 dark:text-white">
                                <?php echo e($workOrder->purchaseOrder->part->number); ?>
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3993217285-0', null);
