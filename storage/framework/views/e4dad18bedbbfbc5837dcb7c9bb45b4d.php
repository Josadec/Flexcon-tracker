<<<<<<<<< Temporary merge branch 1 <<<<<<< HEAD=========<<<<<<<
    HEAD:resources/views/livewire/admin/shifts/shift-create.blade.php=======>>>>>>>>> Temporary merge branch 2
    <?php
    ...
    <<<<<<<<< Temporary merge branch 1=======>>>>>>> 555ab2209e164dfdd7dadecfe262b2c5e57ef8a9
        =========
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mb-8">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Crear Turno</h1>
                            <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                                Ingrese la información del nuevo turno de trabajo
                            </p>
                        </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div class="flex justify-end space-x-3 pt-4 border-t border-gray-200 dark:border-gray-700">
                                <<<<<<<<< Temporary merge branch 1 <<<<<<< HEAD <a href="<?php echo e(route('shifts.index')); ?>"
                                    ...
                                    <a href="<?php echo e(route('admin.shifts.index')); ?>"
                                        ...
                                        =========
                                        <<<<<<< HEAD:resources/views/livewire/admin/shifts/shift-create.blade.php <a
...
<?php /**PATH C:\xampp\htdocs\Flexcon-tracker\resources\views/livewire/admin/shifts/shift-create.blade.php ENDPATH**/ ?>