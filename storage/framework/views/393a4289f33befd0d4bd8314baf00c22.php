                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                            <div class="w-8 h-8 rounded-lg flex items-center justify-center" style="background-color: <?php echo e($status->color); ?>20;">
                                <div class="w-3 h-3 rounded-full" style="background-color: <?php echo e($status->color); ?>;"></div>
                            </div>
                        </div>
                        <div class="ml-4">
                            <p class="text-sm font-medium text-gray-500 dark:text-gray-400"><?php echo e($status->name); ?></p>
                            <p class="text-2xl font-semibold text-gray-900 dark:text-white">
                                <?php echo e(\App\Models\WorkOrder::where('status_id', $status->id)->count()); ?>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gray-50 dark:bg-gray-800">
                            <tr>
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider cursor-pointer" wire:click="sortBy('wo_number')">
                                    ID
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sortField === 'wo_number'): ?>
                                ...
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider cursor-pointer" wire:click="sortBy('opened_date')">
                                    Fecha Apertura
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sortField === 'opened_date'): ?>
                                        <span><?php echo e($sortDirection === 'asc' ? '↑' : '↓'); ?></span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </th>
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-900 dark:divide-gray-700">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm font-semibold text-indigo-600 dark:text-indigo-400">
                                            <?php echo e($wo->purchaseOrder->wo ?? '-'); ?>

                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900 dark:text-white">
                                            <?php echo e($wo->purchaseOrder->po_number ?? '-'); ?>

                                        </div>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($wo->purchaseOrder && $wo->purchaseOrder->part): ?>
                                        <div class="text-xs text-gray-500 dark:text-gray-400">
                                            <?php echo e($wo->purchaseOrder->part->number); ?> - <?php echo e(Str::limit($wo->purchaseOrder->part->description, 25)); ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900 dark:text-white">
                                            <?php echo e($wo->opened_date->format('d/m/Y')); ?>

                                        </div>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($wo->scheduled_send_date): ?>
                                            <div class="text-xs text-gray-500 dark:text-gray-400">
                                                Envío: <?php echo e($wo->scheduled_send_date->format('d/m/Y')); ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900 dark:text-white">
                                            <?php echo e(number_format($wo->sent_pieces)); ?> / <?php echo e(number_format($wo->original_quantity)); ?>

                                        </div>
                                        <div class="text-xs text-gray-500 dark:text-gray-400">
                                            Pendiente: <?php echo e(number_format($wo->pending_quantity)); ?>

                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="px-2 py-1 text-xs font-semibold rounded-full text-white" style="background-color: <?php echo e($wo->status->color); ?>;">
                                            <?php echo e($wo->status->name); ?>

                                        </span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex space-x-2">
                                            <a href="<?php echo e(route('admin.work-orders.show', $wo)); ?>" class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300">
                                                Ver
                                            </a>
                                            <a href="<?php echo e(route('admin.work-orders.edit', $wo)); ?>" class="text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300">
                                                Editar
                                            </a>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($wo->canBeDeleted()): ?>
                                                <button wire:click="confirmDeletion(<?php echo e($wo->id); ?>)" class="text-red-600 hover:text-red-900 dark:text-red-400 dark:hover:text-red-300">
                                                    Eliminar
                                                </button>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($workOrders->count() === 0): ?>
                                <tr>
...
<?php /**PATH C:\xampp\htdocs\Flexcon-tracker\resources\views/livewire/admin/work-orders/wo-list.blade.php ENDPATH**/ ?>