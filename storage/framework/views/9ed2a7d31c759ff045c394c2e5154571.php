    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Editar Rol: <?php echo e($role->name); ?></h1>
        ...
        <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-6">
            <div class="flex items-center">
                ...
                <span class="text-sm text-blue-800 dark:text-blue-200">
                    Este rol está asignado a <strong><?php echo e($role->users()->count()); ?></strong> usuario(s)
                </span>
            </div>
        </div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($permissions->count() > 0): ?>
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center space-x-4 pb-4 border-b border-gray-200 dark:border-gray-700">
                                <button 
                                    type="button"
                                    wire:click="$set('selectedPermissions', <?php echo e($permissions->pluck('id')->toJson()); ?>)"
...
</div><?php /**PATH C:\xampp\htdocs\Flexcon-tracker\resources\views/livewire/admin/roles/role-edit.blade.php ENDPATH**/ ?>