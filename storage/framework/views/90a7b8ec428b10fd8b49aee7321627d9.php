    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center space-x-4">
                <a href="<?php echo e(route('admin.tables.index')); ?>" class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300">
...
</div><?php /**PATH C:\xampp\htdocs\Flexcon-tracker\resources\views/livewire/admin/tables/table-create.blade.php ENDPATH**/ ?>