            ...
            <div class="grid gap-4 md:grid-cols-3">
                ...
                <div class="rounded-lg bg-gray-50 dark:bg-gray-900 p-4">
                    ...
                    <p class="font-medium text-gray-900 dark:text-white">
                        Semana <?php echo e(\Carbon\Carbon::parse($startDate)->weekOfYear); ?> -
                        <?php echo e(\Carbon\Carbon::parse($startDate)->year); ?>
            ...
            <div class="grid gap-4 md:grid-cols-3">
                <div class="rounded-lg bg-blue-50 dark:bg-blue-900/20 p-4 text-center">
                    ...
                    <p class="text-3xl font-bold text-blue-600 dark:text-blue-400">
                        <?php echo e(number_format($totalAvailableHours, 2)); ?></p>
                </div>
                <div class="rounded-lg bg-orange-50 dark:bg-orange-900/20 p-4 text-center">
                    ...
                    <p class="text-3xl font-bold text-orange-600 dark:text-orange-400">
                        <?php echo e(number_format($totalRequiredHours, 2)); ?></p>
                </div>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $workOrderItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="px-4 py-3 font-medium text-indigo-600 dark:text-indigo-400">
                                        <?php echo e($item['wo'] ?? '-'); ?></td>
                                    <td class="px-4 py-3 font-medium text-blue-600 dark:text-blue-400">
                                        <?php echo e($item['po_number'] ?? '-'); ?></td>
                                    <td class="px-4 py-3 font-medium text-gray-900 dark:text-white">
                                        <?php echo e($item['part_number']); ?></td>
                                    <td class="px-4 py-3 text-gray-700 dark:text-gray-300">
                                        <?php echo e(Str::limit($item['part_description'] ?? '', 30)); ?></td>
                                    <td class="px-4 py-3 text-right text-gray-700 dark:text-gray-300">
                                        <?php echo e(number_format($item['quantity'])); ?></td>
                                    <td class="px-4 py-3 text-right font-medium text-gray-900 dark:text-white">
                                        <?php echo e(number_format($item['required_hours'], 2)); ?></td>
                                    <td class="px-4 py-3">
                                        <div class="flex items-center gap-2">
                                                        ...
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(is_array($lot) && !empty($lot['number'])): ?>
                                                            <span
                                                                ...
                                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($lot['quantity'])): ?>
                                                                    <span
                                                                        class="ml-1 text-blue-600 dark:text-blue-300">(<?php echo e(number_format($lot['quantity'])); ?>)</span>
                                            ...
                                            <button wire:click="openLotModal(<?php echo e($index); ?>)" type="button"
                        ...
                        <tfoot class="bg-gray-50 dark:bg-gray-900">
                            <tr>
                                ...
                                <td class="px-4 py-3 text-right font-bold text-gray-900 dark:text-white">
                                    <?php echo e(number_format($totalRequiredHours, 2)); ?> hrs</td>
                                <td></td>
                            </tr>
                        </tfoot>
                    </table>
...
<?php endif; ?>
                        <div>
                            ...
                            <p class="text-sm text-yellow-700 dark:text-yellow-300">
                                Se requieren <?php echo e(number_format($suggestedOvertime, 2)); ?> horas adicionales de tiempo
                                extra.
                            </p>
                        </div>
                    </div>
...
<?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showLotModal && $currentLotIndex !== null): ?>
        <div class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="lot-modal-title" role="dialog"
            aria-modal="true">
            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                
                <div class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity" wire:click="closeLotModal">
                </div>
                ...
                <div
                    ...
                    <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            ...
                            <div>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($workOrderItems[$currentLotIndex])): ?>
                                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                                        PO:
                                        <strong><?php echo e($workOrderItems[$currentLotIndex]['po_number'] ?? 'N/A'); ?></strong>
                                        |
                                ...
                                <div class="flex items-start gap-2">
                                    ...
                                    <div class="flex-1 space-y-2">
                                        <div>
                                            ...
                                            <input type="text" wire:model="tempLots.<?php echo e($lotIndex); ?>.number"
                                                placeholder="Ej: 30"
                                        ...
                                        <div>
                                            ...
                                            <input type="number" wire:model="tempLots.<?php echo e($lotIndex); ?>.quantity"
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($tempLots) > 1): ?>
                                        <button wire:click="removeLotInput(<?php echo e($lotIndex); ?>)" type="button"
                        ...
                        <button wire:click="addLotInput" type="button"
                    ...
                    <div class="bg-gray-50 dark:bg-gray-900 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse gap-2">
                        <button wire:click="saveLots" type="button"
