        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900 dark:text-white"><?php echo e($totalRoles); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-gray-600 dark:text-gray-400">Total Permisos</p>
                        <p class="text-2xl font-semibold text-gray-900 dark:text-white"><?php echo e($totalPermissions); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-gray-600 dark:text-gray-400">Usuarios con Roles</p>
                        <p class="text-2xl font-semibold text-gray-900 dark:text-white"><?php echo e(\App\Models\User::whereHas('roles')->count()); ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 mb-8">
            <div class="p-6">
                <div class="flex flex-col sm:flex-row gap-4">
                    <div class="flex-1">
                        <label for="search" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Buscar roles</label>
                        <div class="relative">
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">No hay roles</h3>
                                        <p class="text-gray-500 dark:text-gray-400 mb-4">No se encontraron roles que coincidan con tu búsqueda.</p>
                                        <a href="<?php echo e(route('admin.roles.create')); ?>" 
...
</div><?php /**PATH C:\xampp\htdocs\Flexcon-tracker\resources\views/livewire/admin/roles/role-list.blade.php ENDPATH**/ ?>