...
class WOList extends Component
{
    ...
    public function deleteWorkOrder(int $id): void
    {
        ...
        try {
            ...
            // <x-ui.note>, igual que el `error` del catch. Si además se
            // flasheara `flash.banner`, el layout lo mostraría por su cuenta y
            // el mensaje quedaría en dos lugares distintos.
            session()->flash('success', 'Orden de trabajo eliminada correctamente.');
        } catch (\Exception $e) {
